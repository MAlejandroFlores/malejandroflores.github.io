...
function weatherSummary() {
    const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.038422395122524&lon=-111.39568418054263&units=imperial&appid=da417c202ea85673351a222150ce05af";
    fetch(apiURL)
...
function weatherForecast() {
    const api_forecast_URL = "https://api.openweathermap.org/data/2.5/forecast?lat=42.038422395122524&lon=-111.39568418054263&units=imperial&appid=da417c202ea85673351a222150ce05af";
        ...
        .then((jsObject) => {
            ...
            jsObject.list.forEach(element => {
                ...
                if (element.dt_txt.includes("18:00")) {
                    ...
                    document.getElementById('forecast_day_' + i).innerHTML = weekdays[(today.getDay() + i) % 7];
